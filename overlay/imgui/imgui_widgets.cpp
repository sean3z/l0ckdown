...
void ImGui::Hotkey(const char* label, int* k, const ImVec2& size_arg)
{
    static bool waiting_for_key = false;
    if (waiting_for_key == false) {
        if (ImGui::Button(key_names[*(int*)k], size_arg))
            waiting_for_key = true;
    }
    else if (waiting_for_key == true) {
...
bool ImGui::ColorEdit4(const char* label, float col[4], ImGuiColorEditFlags flags)
{
    ...
    if (flags & ImGuiColorEditFlags_PickerHueWheel | ImGuiColorEditFlags_NoInputs)
    ...
    if ((flags & (ImGuiColorEditFlags_DisplayRGB | ImGuiColorEditFlags_DisplayHSV)) != 0 && (flags & ImGuiColorEditFlags_PickerHueWheel | ImGuiColorEditFlags_NoInputs) == 0)
    {
    ...
    else if ((flags & ImGuiColorEditFlags_DisplayHex) != 0 && (flags & ImGuiColorEditFlags_PickerHueWheel | ImGuiColorEditFlags_NoInputs) == 0)
    {
    ...
    {
        const float button_offset_x = ((flags & ImGuiColorEditFlags_PickerHueWheel | ImGuiColorEditFlags_NoInputs) || (style.ColorButtonPosition == ImGuiDir_Left)) ? 0.0f : w_inputs + style.ItemInnerSpacing.x;
    ...
    if (label != label_display_end && !(flags & ImGuiColorEditFlags_NoLabel))
    {
        ...
        window->DC.CursorPos.x = pos.x + ((flags & ImGuiColorEditFlags_PickerHueWheel | ImGuiColorEditFlags_NoInputs) ? w_button : w_full + style.ItemInnerSpacing.x);
        TextEx(label, label_display_end);
    }
...
bool ImGui::ColorPicker4(const char* label, float col[4], ImGuiColorEditFlags flags, const float* ref_col)
{
    ...
    if ((flags & ImGuiColorEditFlags_PickerHueWheel | ImGuiColorEditFlags_NoInputs) == 0)
    {
...
void ImGui::ColorPickerOptionsPopup(const float* ref_col, ImGuiColorEditFlags flags)
{
    ...
    if (allow_opt_picker)
    {
        ...
        for (int picker_type = 0; picker_type < 2; picker_type++)
        {
            ...
            PushID(picker_type);
            ImGuiColorEditFlags picker_flags = ImGuiColorEditFlags_PickerHueWheel | ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_NoOptions | ImGuiColorEditFlags_NoLabel | ImGuiColorEditFlags_NoSidePreview | (flags & ImGuiColorEditFlags_NoAlpha);
